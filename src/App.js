...
const createElement = (id, x1, y1, x2, y2, type, points) => ({
  id,
  x1,
  y1,
  x2,
...
const draw = (context, element) => {
  const { id, x1, y1, x2, y2, type, points } = element;
  switch (type) {
    case "rectangle":
  ...
  return (
    <div>
      <div style={{ position: "fixed" }}>
        ...
        />
        <label htmlFor="selection">Circle</label>
        <input
          type="radio"
          id="triangle"
        ...
        />
        <label htmlFor="selection">Triangle</label>
        <input
          type="radio"
          id="line"
          checked={tool === "line"}
